...
public class Login_Details_Impl implements Login_Service {
    ...
    @Override
    public String user_login(Login_Details login_details) {
    ...
    @Override
    public String change_password(Forget_Password_Details forget_password_details) {
        Customer_Details_Table customer_details_table = customer_details_table_repository
                .findById(forget_password_details.getUser_email_id())
                .orElseThrow(() -> new User_Not_Found_Exception("Given user email id not even have an " +
                        "account so create an account by clicking sign_up"));
        ...
        if(Security_Question1.get(forget_password_details.security_question1).
                equals(forget_password_details.getSecurity_answer1())&&
                Security_Question2.get(forget_password_details.security_question2).
                        equals(forget_password_details.getSecurity_answer2()))
        {
