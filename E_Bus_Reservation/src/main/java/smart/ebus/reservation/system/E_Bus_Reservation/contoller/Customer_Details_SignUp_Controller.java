...
public class Customer_Details_SignUp_Controller {
    ...
    public ResponseEntity<Customer_Details_Table> new_customer_details(@RequestBody Sign_Up_Request sign_up_request)
    {
        return new ResponseEntity<Customer_Details_Table>(customer_details_service.customer_details(sign_up_request), HttpStatus.ACCEPTED);
