...
public class Check_Bus_Availability_Impl implements Check_Bus_Availability_Service {
    ...
    public List<Available_Bus_Response> check_bus_availability(Available_Bus_Request available_bus_request) {
       ...
       //         air_india_travels.getAmenities(), air_india_travels.getStart_time(),air_india_travels.getEnd_time(),air_india_travels.getBus_fare()));
        ...
        Essar_Travels essar_travels=essar_travels_repository.findBySourceAndDestinationOrTraveldate(available_bus_request.getSource(),available_bus_request.getDestination(),available_bus_request.getTravel_date());
        ...
        Ganapathy_Travels ganapathy_travels=ganapathy_travels_repository.findBySourceAndDestinationOrTraveldate(available_bus_request.getSource(),available_bus_request.getDestination(),available_bus_request.getTravel_date());
        ...
        Krish_Travels krish_travels=krish_travels_repository.findBySourceAndDestinationOrTraveldate(available_bus_request.getSource(),available_bus_request.getDestination(),available_bus_request.getTravel_date());
        ...
        No_1_Air_Travels no_1_air_travels=no_1_air_travels_repository.findBySourceAndDestinationOrTraveldate(available_bus_request.getSource(),available_bus_request.getDestination(),available_bus_request.getTravel_date());
        ...
        Orange_Tour_Travels orange_tour_travels=orange_tour_travels_repository.findBySourceAndDestinationOrTraveldate(available_bus_request.getSource(),available_bus_request.getDestination(),available_bus_request.getTravel_date());
        ...
        Sri_Krishna_Travels sri_krishna_travels=sri_krishna_travels_repository.findBySourceAndDestinationOrTraveldate(available_bus_request.getSource(),available_bus_request.getDestination(),available_bus_request.getTravel_date());
