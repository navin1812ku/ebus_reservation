...
public class Login_Controller {
    ...
    public ResponseEntity<String> check_user(@RequestBody Login_Details login_details)
    {
        return new ResponseEntity<String>(login_service.user_login(login_details), HttpStatus.OK);
    }

    @PutMapping("/login/forget_password/")
    public ResponseEntity<String> change_password(@RequestBody Forget_Password_Details forget_password_details)
    {
        return new ResponseEntity<String>(login_service.change_password(forget_password_details),HttpStatus.CONTINUE);
    }
}
