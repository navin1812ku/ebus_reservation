...
public class Payment_Details_Controller {
    ...
    public ResponseEntity<Journey_Details_Entity> payment_details(@RequestBody Journey_Details_Entity journey_detailsEntity)
    {
        return new ResponseEntity<Journey_Details_Entity>(payment_details_service.total_amount(journey_detailsEntity), HttpStatus.CREATED);
    }
